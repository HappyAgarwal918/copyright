    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                <img src="{{asset('asset/images/4446399.png')}}" class="img-fluid animated" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{asset('asset/images/icons/globe-protection.png')}}" alt="">
                    </div>
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <p><a class="" href="{{ route('protect-websites') }}">Learn more</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{asset('asset/images/icons/copyright-work.png')}}" alt="">
                    </div>
                    <div>
                    ...
                    <div class="service-details">
                        ...
                        <p><a class="" href="{{ route('copyright-works') }}">Learn more</a></p>
                    </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="{{asset('asset/images/icons/law.png')}}" alt="">
                    </div>
                    <div>
                    ...
                    <div class="service-details">
                        ...
                        <p><a class="" href="{{ route('professional-takedowns') }}">Learn more</a></p>
                    </div>
                    </div>
                </div>
            </div>
