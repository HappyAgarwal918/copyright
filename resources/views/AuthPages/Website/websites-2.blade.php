...
@php $data = DB::table('website')->where('method', $uniqid)->first(); @endphp
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">Verify website ownership - {{ $data->Url }}</div>
                </div>
            </div>
        </div>
    </div>
  	...
  	<div class="container">
    	<div class="panel-group">
      		<div class="panel panel-primary">
			    ...
			    @endif
        		<form action="{{ route('websites-view',$data->method) }}" method="post">
          		@csrf            
