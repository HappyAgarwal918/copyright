...
<head>
    ...
    <link href="{{ asset('asset/css/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
    ...
    <link href="{{ asset('asset/css/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
...
<script src="{{asset('asset/js/analytics.js')}}"></script>

<!-- Form javascript -->
<script src="{{asset ('asset/js/formjquery.js')}}"></script>
